...
class classify:
    ...
    def Classify(self):
        ...
        self.clf = joblib.load(self.basic_path + "/model/svm_type.m")

        # from corpus import get_keywords
        keywords_list = self.get_keywords(self.basic_path + '/data/type_keywords.txt')
        irrewords_list = self.get_keywords(self.basic_path + '/data/type_irrewords.txt')
...
def test_twitter_type(text, basic_path = Basic_Path):
    type_ = "twitter_type"
...
if __name__ == "__main__":
    # test_dict()
    # test_twitter_type("RT @chinascio: Chinese #AirForce releases promo video to celebrate National Day. #PRC70 ")
    pass
