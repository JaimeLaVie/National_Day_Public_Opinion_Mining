...
class Test:
    ...
    def test_type_dict_svm(self):
        ...
        keywords_list = get_keywords('data/type_keywords.txt')
        # print (keywords_list)
        irrewords_list = get_keywords('data/type_irrewords.txt')
