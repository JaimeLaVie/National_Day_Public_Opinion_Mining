...
class classify:
    ...
    def Classify(self):
        ...
        self.clf = joblib.load(self.basic_path + "/model/svm_sentiment.m")
...
def test_twitter_sentiment(text, basic_path = Basic_Path):
...
if __name__ == "__main__":
    # test_dict()
    # test_twitter_sentiment("# 国庆 祝愿 祖国 母亲 节日 快乐 ， 国庆 快乐 🇨🇳")
    pass
