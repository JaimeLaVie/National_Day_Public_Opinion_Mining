...
class classify:
    ...
    def Classify(self):
        ...
        self.clf = joblib.load(self.basic_path + "/model/svm_rele_en.m")
...
def test_twitter_rele_en(text, basic_path = Basic_Path):
    type_ = "twitter_rele_en"
...
if __name__ == "__main__":
    # test_dict()
    # test_twitter_rele_en("RT @chinascio: Chinese #AirForce releases promo video to celebrate National Day. #PRC70 ")
    pass
