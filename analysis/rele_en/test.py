...
class Test:
    ...
    def test_rele_dict_svm(self):
        ...
        keywords_list = get_keywords('data/rele_keywords.txt')
        # print (keywords_list)
        irrewords_list = get_keywords('data/rele_irrewords.txt')
