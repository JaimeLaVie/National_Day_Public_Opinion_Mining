...
class classify:
    ...
    def Classify(self):
        ...
        self.clf = joblib.load(self.basic_path + "/model/svm_sentiment_en.m")

        # from corpus import get_keywords
        keywords_list = self.get_keywords(self.basic_path + '/data/sentiment_keywords.txt')
        irrewords_list = self.get_keywords(self.basic_path + '/data/sentiment_irrewords.txt')
...
def test_twitter_sentiment_en(text, basic_path = Basic_Path):
...
if __name__ == "__main__":
    # test_dict()
    # test_twitter_sentiment_en("RT @chinascio: Chinese #AirForce releases promo video to celebrate National Day. #PRC70 ")
    pass
