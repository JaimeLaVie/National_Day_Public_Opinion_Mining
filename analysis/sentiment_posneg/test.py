...
class Test:
    ...
    def test_sentiment_posneg_dict_svm(self):
        print("SVMClassifier")
        print("---" * 30)
        ...
        keywords_list = get_keywords('data/sentiment_pos_keywords.txt')
        # print (keywords_list)
        irrewords_list = get_keywords('data/sentiment_neg_irrewords.txt')
...
def test_twitter_sentiment_posneg():
    ...
    test.test_sentiment_posneg_dict_svm()


if __name__ == "__main__":
    # test_dict()
    test_twitter_sentiment_posneg()
